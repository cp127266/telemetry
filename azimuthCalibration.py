...
def turnAZ(deg, pig = pigpio.pi(), sleepTime = 5):
    ...
    #pulse_width = servo_pulse_min + (deg * (servo_pulse_max - servo_pulse_min) / 180) # TODO: find a way to change zeros
    pulse_width = 1506 - 4.4822 * deg
    pig.set_servo_pulsewidth(25, pulse_width)
    time.sleep(sleepTime)
    
def turnEL(deg, pig = pigpio.pi(), sleepTime = 5):
    ...
    #pulse_width = servo_pulse_min + (deg * (servo_pulse_max - servo_pulse_min) / 180) # TODO: find a way to change zeros
    pulse_width = 1498 - 10.1 * deg
    pig.set_servo_pulsewidth(24, pulse_width)
    time.sleep(sleepTime)

def sendZeroAZ(pig, deg, sleepTime = 5):
